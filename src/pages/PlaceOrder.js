...
const PlaceOrder = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col  sm:flex-row  justify-between gap-32 pt-5 sm:pt-14 min-h-[80vh] border-t '>
        <div className='flex lg:w-1/2 flex-col gap-4 w-full sm:max-w[480px]'>
            ...
            <div className='mt-12'>
                ...
                <div className='flex gap-3 flex-col lg:flex-row'>
                    ...
                    <div onClick={()=>setMethod('cod')} className='flex items-center gap-3  border p-2 px-3 cursor-pointer'>
                        ...
                        <p className='text-gray-500 text-sm font-medium mx-4 whitespace-nowrap'>CASH ON DELIVERY</p>
                    </div>
                </div>
